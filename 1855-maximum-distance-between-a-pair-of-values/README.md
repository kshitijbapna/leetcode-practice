...
<pre style="position: relative;"><strong>Input:</strong> nums1 = [55,30,5,4,2], nums2 = [100,20,10,10,5]
...
<pre style="position: relative;"><strong>Input:</strong> nums1 = [2,2,2], nums2 = [10,10,1]
...
<pre style="position: relative;"><strong>Input:</strong> nums1 = [30,29,19,5], nums2 = [25,25,25,25,25]
<strong>Output:</strong> 2
